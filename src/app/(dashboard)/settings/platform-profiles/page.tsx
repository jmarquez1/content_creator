  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex h-20 items-center justify-between bg-white/50 backdrop-blur-sm border-b border-[var(--color-border)] px-6">
        <div>
          <h1 className="text-2xl font-bold text-[var(--color-foreground)]">Platform Profiles</h1>
          <p className="text-sm text-[var(--color-muted-foreground)]">Configure platform-specific content formatting</p>
        </div>
